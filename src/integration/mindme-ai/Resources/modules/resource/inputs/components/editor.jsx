 ...
 */
const ResourceInputsEditor = ({hostId}) => {
  const dispatch = useDispatch()
  const [inputs, setInputs] = useState([])

  // loads the current input references
  useEffect(() => {
    const cancelable = makeCancelable(apiFetch({url: API(hostId)}, dispatch))
