...
import {API} from '#/integration/mindme-aibase/resource/inputs/constants'
...
const ResourceInputs = ({hostId}) => {
  const [data, status] = useFetch(`resourceInputs-${hostId}`, hostId ? API(hostId) : null)

  if (!hostId || 'pending' === status) {
    return null
  }
