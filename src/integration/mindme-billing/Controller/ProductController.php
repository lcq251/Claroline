...
namespace Mindme\BillingBundle\Controller;
...
use Mindme\BillingBundle\Entity\ProductStatus;
use Mindme\BillingBundle\Serializer\ProductSerializer;
...
class ProductController
{
    ...
    /**
     * Updates a product's price & description (code & target are immutable).
     */
    #[Route('/apiv2/product/{id}', name: 'apiv2_mindme_product_update', methods: ['PUT'])]
