...
const PageAffixCard = (props) =>
  <div className={classes('rounded-2 shadow p-4', props.className)} role="presentation">
    {props.children}
    ...
    {!isEmpty(props.info) &&
      <ul className="list-unstyled mb-0">
        {props.info
          ...
          .map(info =>
            <li key={info.label} className="list-group-item d-flex align-items-baseline text-body-secondary fs-sm mt-4">
              {info.icon &&
...
const PageAffix = props =>
  ...
  >
    ...
    <div className="sticky-top z-1 p-4 content-xs m-0" role="presentation">
      {props.affix}
    </div>
  </div>
