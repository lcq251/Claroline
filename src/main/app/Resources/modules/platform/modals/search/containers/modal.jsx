...
import {SearchModal as SearchModalComponent} from '#/main/app/platform/modals/search/components/modal'
import {actions, reducer, selectors} from '#/main/app/platform/modals/search/store'
