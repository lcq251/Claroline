...
class Documentator
{
    ...
    public function documentRoute(Route $route): array
    {
        $extended = [];
        ...
        return array_merge([], $extended);
    }

    public function documentClass($class): array
    {
    ...
    private function parseDoc(ApiDoc $doc, $objectClass): array
    {
        $data = ['parameters' => []];
    ...
    private function parseDescription($description, $objectClass): string
    {
        return str_replace('$class', $objectClass, $description);
    }

    private function parseParameters($parameters, $objectClass): array
    {
        $doc = [];
    ...
    private function parseQueryString($queryStrings, $objectClass): array
    {
        $doc = [];
    ...
    private function parseBody($body, $objectClass): array
    {
        $requestBody = [];
        $examples = [];
        $data = [];
    ...
    private function parseResponse($responses, $objectClass): array
    {
        $data = [];
