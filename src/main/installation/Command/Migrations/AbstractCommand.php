...
namespace Claroline\InstallationBundle\Command\Migrations;
...
abstract class AbstractCommand extends Command
{
    ...
    public function setManager(MigrationsManager $manager): void
    {
    ...
    protected function getManager(OutputInterface $output): MigrationsManager
    {
