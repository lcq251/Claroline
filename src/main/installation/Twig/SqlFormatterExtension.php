...
namespace Claroline\InstallationBundle\Twig;

use Claroline\InstallationBundle\Migrations\SqlFormatter as Formatter;
...
class SqlFormatterExtension extends AbstractExtension
{
     ...
     */
    public function formatSql(string $sql, int $tabOffset = 3): string
    {
        $tab = Formatter::$tab;
        $indent = '';
