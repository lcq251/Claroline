 ...
 *
 * Generation date: 2023/07/10 02:01:13
 */
final class Version20230421084352 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql("
            CREATE TABLE claro_clacoformbundle_claco_form (
                ...
                showConfirm TINYINT(1) NOT NULL, 
                confirmMessage LONGTEXT DEFAULT NULL, 
                helpMessage LONGTEXT DEFAULT NULL, 
        ...
        $this->addSql('
            CREATE TABLE claro_clacoformbundle_field (
                ...
                UNIQUE INDEX field_unique_name (claco_form_id, field_facet_id), 
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        ');
        $this->addSql("
    ...
    public function down(Schema $schema): void
    {
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_claco_form 
            DROP FOREIGN KEY FK_ACB82378B87FAB32
        ');
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_category 
        ...
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_category_manager 
            DROP FOREIGN KEY FK_562FC194A76ED395
        ');
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_field 
        ...
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_field 
            DROP FOREIGN KEY FK_F84976F72AB018E9
        ');
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_field_choice_category 
        ...
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_field_choice_category 
            DROP FOREIGN KEY FK_1F7C5EF7E07710C3
        ');
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_keyword 
        ...
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_comment 
            DROP FOREIGN KEY FK_23B30E0A76ED395
        ');
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_comment 
        ...
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_entry_user 
            DROP FOREIGN KEY FK_7036190CA76ED395
        ');
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_field_value 
        ...
        $this->addSql('
            ALTER TABLE claro_clacoformbundle_field_value 
            DROP FOREIGN KEY FK_B481BDB9D4EE0DAB
        ');
        $this->addSql('
