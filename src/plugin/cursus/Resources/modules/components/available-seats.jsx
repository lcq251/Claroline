...
const AvailableSeats = (props) => {
  ...
  if (0 > availableSeats) {
    return (
      <Badge className={props.className} subtle={true} variant="danger">
        {transChoice('missing_seats_count', Math.abs(availableSeats), {count: Math.abs(availableSeats)}, 'cursus')}
      </Badge>
    )
  }
