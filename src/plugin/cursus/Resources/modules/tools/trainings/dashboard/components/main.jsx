...
import {PageColumns, PageColumnPrimary, PageColumnSecondary, PageSection} from '#/main/app/page'
      ...
      <PageColumns>
          ...
          >
            <div className="card">
              <div className="d-flex align-items-baseline p-4 pt-3">
                ...
                <nav className="nav nav-pills ms-auto fs-sm">
        ...
        <PageColumnSecondary>
          <PageSection size="full" className="mt-4">
            <h2 className="page-section-title h6">Activité récente</h2>
          </PageSection>
        </PageColumnSecondary>
      </PageColumns>
    </ToolPage>
