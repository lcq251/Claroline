 ...
 *
 * Generation date: 2023/07/10 02:31:29
 */
final class Version20230421084536 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("
            CREATE TABLE claro_dropzonebundle_document (
                ...
                file_array LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', 
