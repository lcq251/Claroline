 ...
 *
 * Generation date: 2023/07/10 01:51:52
 */
final class Version20230117110740 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('
            CREATE TABLE ujm_exercise (
                ...
                endStats VARCHAR(255) NOT NULL, 
                overviewStats VARCHAR(255) NOT NULL, 
                ...
                questionNumbering VARCHAR(255) NOT NULL, 
                showTitles TINYINT(1) NOT NULL, 
                showQuestionTitles TINYINT(1) NOT NULL, 
                ...
                INDEX IDX_374DF52548FD0A1B (end_back_target_id), 
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        ');
        $this->addSql('
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('
            ALTER TABLE ujm_exercise 
            DROP FOREIGN KEY FK_374DF525B87FAB32
        ');
        $this->addSql('
            ALTER TABLE ujm_exercise 
        ...
        $this->addSql('
            ALTER TABLE ujm_question_resource 
            DROP FOREIGN KEY FK_B47B5FFCB87FAB32
        ');
        $this->addSql('
            ALTER TABLE ujm_share 
        ...
        $this->addSql('
            ALTER TABLE ujm_boolean_choice 
            DROP FOREIGN KEY FK_B9216398B87FAB32
        ');
        $this->addSql('
            ALTER TABLE ujm_boolean_choice 
        ...
        $this->addSql('
            ALTER TABLE ujm_grid_item 
            DROP FOREIGN KEY FK_66B59764B87FAB32
        ');
        $this->addSql('
            ALTER TABLE ujm_grid_odd 
        ...
        $this->addSql('
            ALTER TABLE ujm_ordering_item 
            DROP FOREIGN KEY FK_360C6C62B87FAB32
        ');
        $this->addSql('
            ALTER TABLE ujm_proposal 
